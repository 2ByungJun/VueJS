let mathUtil,log;_e5f‍.w("../mathUtil",[["default",["mathUtil"],function(v){mathUtil=v}]]);_e5f‍.w("./log",[["default",["log"],function(v){log=v}]]);const readLine = require('readline'); // readline 내장 모듈
    ...
    figure => {
        ...
        switch(figure){
            ...
            case '원':
                ...
                break;
            default:
                _e5f‍.g.console.log(log.logError);
                rl.close();
                break;
        }
    }
